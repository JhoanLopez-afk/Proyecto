...
public class FabricaCartas {
    public static ArrayList<Carta> crearCartas(){
        ...
        cartas.add(new Mounstro("Bruja Oscura Dunames", (short) 1800, (short) 1050, TipoCarta.MOUNSTRUO, Mounstro.Estrellas.Cuatro, true, "Aun cuando las posibilidades estén en su contr, esta brava hada avanzará en la batalla y jamás retrocederá.", Estado.BARAJA));
        ...
        cartas.add(new Mounstro("Cerebro Antiguo", (short) 1000, (short) 700, TipoCarta.MOUNSTRUO, Mounstro.Estrellas.Tres, true, "Una hada caíada que es poderosa en la oscuridad", Estado.BARAJA));
        ...
        cartas.add(new Mounstro("Exodia, el prohibido", (short) 200, (short) 300, TipoCarta.MOUNSTRUO, Mounstro.Estrellas.Una, true, "Si tienes PIERNA DERECHA DEL PROHIBIDO, PIERNA IZQUIERDA DEL PROHIBIDO, BRAZO DERECHO DEL PROHIBIDO y BRAZO IZQUIERDO DEL PROHIBIDO, ademas de esta carta en tu mano, ganas el Duelo.", Estado.BARAJA));
        ...
        cartas.add(new Mounstro("Dragón Blanco de Ojos Azules", (short) 3000, (short) 2500, TipoCarta.MOUNSTRUO, Mounstro.Estrellas.Ocho, true, "Este legendario dragón es una poderosa máquina de destruccion. Virtulmente invencible, muy pocos se hn enfrentado a esta impresionante criatura y han vivido para contarlo", Estado.BARAJA));
        ...
        cartas.add(new Mounstro("Madoor de Aqua", (short) 1200, (short) 2000, TipoCarta.MOUNSTRUO, Mounstro.Estrellas.Cuatro, true, "Unmago de as aguas que conjura un muro liquido para aplastar a cualquier enemigo que se le enfrente", Estado.BARAJA));
